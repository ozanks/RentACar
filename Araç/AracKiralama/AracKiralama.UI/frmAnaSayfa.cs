                ...
                foreach (Musteri item in musteriler)
                {
                    if (item.Id==girisYapanId)
                    {
                        ...
                        else
                        {
                            ...
                            frmKiralamaEkrani frm = new frmKiralamaEkrani();
                            frm.kiralanacakBilgi.GetirilenTarih = dtpTeslimedilecek.Value;
                            frm.kiralanacakBilgi.MusteriId = girisYapanId;
                            //frm.kiralanacakBilgi.ToplamFiyat = Convert.ToDecimal(lblToplamFiyat.Text);
                            frm.kiralanacakBilgi.AlinanTarih = dtpAlinacak.Value;
                            frm.kiralanacakBilgi.AracId = seciliArabaId;
                            frm.ShowDialog();
